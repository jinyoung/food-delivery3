...
pluralCaseList.push( {plural: "fronts/menus", pascal: "FrontMenu"} )
pluralCaseList.push( {plural: "fronts/orders", pascal: "FrontOrder"} )
pluralCaseList.push( {plural: "fronts/riders", pascal: "FrontRider"} )
pluralCaseList.push( {plural: "fronts/deliveries", pascal: "FrontDelivery"} )
pluralCaseList.push( {plural: "fronts/notifications", pascal: "FrontNotification"} )
pluralCaseList.push( {plural: "fronts/transactions", pascal: "FrontTransaction"} )

pluralCaseList.push( {plural: "stores/stores", pascal: "StoreStore"} )
pluralCaseList.push( {plural: "stores/owners", pascal: "StoreOwner"} )
